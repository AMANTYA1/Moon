...
from Yuriko.modules.helper_funcs.decorators import kigcmd, kigcallback, kigmsg
...
def send_help(chat_id, text, keyboard=None):
    ...
    if not keyboard:
        ...
        kb.append([InlineKeyboardButton(text='Support', url='https://t.me/PmPermit'),
                    ...
                    [
                        ...
                        [
                            InlineKeyboardButton(
                                ...
                                url='https://t.me/PmPermit',
                            ),
                            InlineKeyboardButton(
                                text=gs(chat.id, "updates_channel_link_btn"),
                                url="https://t.me/BotDuniya",
                            ),
                        ],
                        [
                            InlineKeyboardButton(
...
if __name__ == "__main__":
    log.info("[Yuriko] Successfully loaded modules: " + str(ALL_MODULES))
